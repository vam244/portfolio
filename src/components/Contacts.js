...
const Contacts = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_0gllnd9', 'template_pelkbt7', form.current, 'Mkb-upIFQ1oLrXzfL')
            .then((result) => {
                setName("")
                setEmail("")
                setSubject("")
    ...
    return (
        <div name='contact' className='bg-lb h-[100%] flex flex-col items-center  mx-[20px] mb-[80px]'>
