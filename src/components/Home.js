                ...
                <div className='md:h-[200px] md:w-[700px] mb-11 lg:mr-44 '>
                    ...
                    <Slide top>
                        <div className='bg-lb flex mt-10'>
                            <a href='https://drive.google.com/file/d/1kvm-t3QrarRlamE4PbkaKPtNe8KcUImj/view?usp=sharing' target='_blank' rel="noreferrer" className='bg-nav text-midnight font-[500] mr-3 w-[50%] bg-midnight-800 text-white px-3 py-2 rounded-sm hover:cursor-pointer text-center transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300' >Resume</a>
